  ...
  function nf90_put_att_one_FourByteReal(ncid, varid, name, values)
    ...
    valuesA(1) = values
    nf90_put_att_one_FourByteReal = -1 ! put_att_real(ncid, varid, name, nf90_real4, 1, valuesA)
  ...
  function nf90_get_att_FourByteReal(ncid, varid, name, values)
    ...
    nf90_get_att_FourByteReal = -1 ! nf_get_att_real(ncid, varid, name, values)
  ...
  function nf90_get_att_one_FourByteReal(ncid, varid, name, values)
    ...
    real (kind =  FourByteReal), dimension(1) :: valuesA
    nf90_get_att_one_FourByteReal = -1 ! nf_get_att_real(ncid, varid, name, valuesA)
    values = valuesA(1)
  ...
  function nf90_put_att_EightByteReal(ncid, varid, name, values)
    ...
    nf90_put_att_EightByteReal = -1 ! nf_put_att_double(ncid, varid, name, nf90_real8, size(values), values)
  ...
  function nf90_put_att_one_EightByteReal(ncid, varid, name, values)
    ...
    valuesA(1) = values
    nf90_put_att_one_EightByteReal = -1 ! nf_put_att_double(ncid, varid, name, nf90_real8, 1, valuesA)
  ...
  function nf90_get_att_EightByteReal(ncid, varid, name, values)
    ...
    nf90_get_att_EightByteReal = -1 ! nf_get_att_double(ncid, varid, name, values)
  ...
  function nf90_get_att_one_EightByteReal(ncid, varid, name, values)
    ...
    real (kind = EightByteReal), dimension(1) :: valuesA
    nf90_get_att_one_EightByteReal = -1 ! nf_get_att_double(ncid, varid, name, valuesA)
    values = valuesA(1)
