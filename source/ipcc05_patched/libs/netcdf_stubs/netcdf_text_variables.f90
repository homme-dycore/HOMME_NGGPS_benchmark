   function nf90_put_var_text(ncid, varid, values, start, count, stride, map)
     ...
     nf90_put_var_text = -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, trim(values))
   ...
   function nf90_get_var_text(ncid, varid, values, start, count, stride, map)
     ...
     nf90_get_var_text = -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values)
   ...
   function nf90_put_var_1D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1))
     else
       nf90_put_var_1D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1))
     end if
   ...
   function nf90_put_var_2D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_2D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1))
     else
       nf90_put_var_2D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1))
     end if
   ...
   function nf90_put_var_3D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_3D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1))
     else
       nf90_put_var_3D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1))
     end if
   ...
   function nf90_put_var_4D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_4D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1))
     else
       nf90_put_var_4D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1))
     end if
   ...
   function nf90_put_var_5D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_5D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1))
     else
       nf90_put_var_5D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1))
     end if
   ...
   function nf90_put_var_6D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_6D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1,1))
     else
       nf90_put_var_6D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1,1))
     end if
   ...
   function nf90_put_var_7D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_7D_text = &
          -1 ! nf_put_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1,1,1))
     else
       nf90_put_var_7D_text = &
          -1 ! nf_put_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1,1,1))
     end if
   ...
   function nf90_get_var_1D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1))
     else
       nf90_get_var_1D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1))
     end if
   ...
   function nf90_get_var_2D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_2D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1))
     else
       nf90_get_var_2D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1))
     end if
   ...
   function nf90_get_var_3D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_3D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1))
     else
       nf90_get_var_3D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1))
     end if
   ...
   function nf90_get_var_4D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_4D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1))
     else
       nf90_get_var_4D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1))
     end if
   ...
   function nf90_get_var_5D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_5D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1))
     else
       nf90_get_var_5D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1))
     end if
   ...
   function nf90_get_var_6D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_6D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1,1))
     else
       nf90_get_var_6D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1,1))
     end if
   ...
   function nf90_get_var_7D_text(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_7D_text = &
          -1 ! nf_get_varm_text(ncid, varid, localStart, localCount, localStride, localMap, values(1,1,1,1,1,1,1))
     else
       nf90_get_var_7D_text = &
          -1 ! nf_get_vars_text(ncid, varid, localStart, localCount, localStride, values(1,1,1,1,1,1,1))
     end if
