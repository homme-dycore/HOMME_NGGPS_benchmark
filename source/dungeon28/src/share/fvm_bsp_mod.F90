...
!          call analytical_function(fvm%dp_fvm(i,j,k,n0_fvm),fvm%centersphere(i,j),k,0)!dbg      
        end do
      end do
    end do 
  end do
    ...
    do itr=1,ntrac
      do j=1,nc
        do i=1,nc               
          ...
          call analytical_function(fvm%dp_fvm(i,j,k,tl%n0),fvm%centersphere(i,j),k,0)      !dbg
        end do
      end do
    end do 
  end do
