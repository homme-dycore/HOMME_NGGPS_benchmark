MODULE dcmip_123_mod !dcmip_initial_conditions_test_1_2_3
  ...
  ! use HOMME values for physical constants
  use physical_constants, only: a=>rearth, p0, g, Rd=>Rgas, pi=>dd_pi, cp
...
!use control_mod, only: dcmip2_mh, dcmip2_mw, dcmip2_mwl, dcmip2_ueq
...
! Test 3-1
!==========
SUBROUTINE test3_gravity_wave (lon,lat,p,z,zcoords,hybrid_eta,hyam,hybm,u,v,w,t,phis,ps,rho,q)
