...
!-----------------------------------------------------------------------
   ...
   integer,parameter,public :: t_detail_minimal = 0 
   integer,parameter,public :: t_detail_low     = 1 
   integer,parameter,public :: t_detail_medium  = 2
   integer,parameter,public :: t_detail_high    = 3
   integer,parameter,public :: t_detail_max     = 9999
