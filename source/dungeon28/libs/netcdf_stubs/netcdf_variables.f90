  ...
  function nf90_def_var_Scalar(ncid, name, xtype, varid)
    ...
    nf90_def_var_Scalar = -1 ! nf_def_var(ncid, name, xtype, 0, dimids, varid)
  ...
  function nf90_def_var_oneDim(ncid, name, xtype, dimids, varid)
    ...
    dimidsA(1) = dimids
    nf90_def_var_oneDim = -1 ! nf_def_var(ncid, name, xtype, 1, dimidsA, varid)
  ...
  function nf90_def_var_ManyDims(ncid, name, xtype, dimids, varid)
    ...
    nf90_def_var_ManyDims = -1 ! nf_def_var(ncid, name, xtype, size(dimids), dimids, varid)
  ...
  function nf90_inq_varid(ncid, name, varid)
    ...
    nf90_inq_varid = -1 ! nf_inq_varid(ncid, name, varid)
  ...
  function nf90_Inquire_Variable(ncid, varid, name, xtype, ndims, dimids, nAtts)
    ...
    nf90_Inquire_Variable = -1 ! nf_inq_var(ncid, varid, varName, externalType, &
  ...
  function nf90_rename_var(ncid, varid, newname)
    ...
    nf90_rename_var = -1 ! nf_rename_var(ncid, varid, newname)
