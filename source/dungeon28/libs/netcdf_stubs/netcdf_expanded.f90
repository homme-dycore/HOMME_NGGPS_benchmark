   ...
   function nf90_put_var_OneByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_OneByteInt = -1 ! nf_put_var1_int1(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_TwoByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_TwoByteInt = -1 ! nf_put_var1_int2(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_FourByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_FourByteInt = -1 ! nf_put_var1_int(ncid, varid, localIndex, int(values))
   ...
   function nf90_put_var_EightByteInt(ncid, varid, values, start)
     ...
     nf90_put_var_EightByteInt = -1 ! nf_put_var1_int(ncid, varid, localIndex, int(values))
   ...
   function nf90_put_var_FourByteReal(ncid, varid, values, start)
     ...
     nf90_put_var_FourByteReal = -1 ! nf_put_var1_real(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_EightByteReal(ncid, varid, values, start)
     ...
     nf90_put_var_EightByteReal = -1 ! nf_put_var1_double(ncid, varid, localIndex, values)
   ...
   function nf90_get_var_OneByteInt(ncid, varid, values, start)
     ...
     nf90_get_var_OneByteInt = -1 ! nf_get_var1_int1(ncid, varid, localIndex, values)
   ...
   function nf90_get_var_TwoByteInt(ncid, varid, values, start)
     ...
     nf90_get_var_TwoByteInt = -1 ! nf_get_var1_int2(ncid, varid, localIndex, values)
   ...
   function nf90_get_var_FourByteInt(ncid, varid, values, start)
     ...
     nf90_get_var_FourByteInt = -1 ! nf_get_var1_int(ncid, varid, localIndex, defaultInteger)
   ...
   function nf90_get_var_EightByteInt(ncid, varid, values, start)
     ...
     nf90_get_var_EightByteInt = -1 ! nf_get_var1_int(ncid, varid, localIndex, defaultInteger)
     values = defaultInteger
   ...
   function nf90_get_var_FourByteReal(ncid, varid, values, start)
     ...
     nf90_get_var_FourByteReal = -1 ! nf_get_var1_real(ncid, varid, localIndex, values)
   ...
   function nf90_get_var_EightByteReal(ncid, varid, values, start)
     ...
     nf90_get_var_EightByteReal = -1 ! nf_get_var1_double(ncid, varid, localIndex, values)
   ...
   function nf90_put_var_1D_OneByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_OneByteInt = &
          -1 ! nf_put_varm_int1(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_put_var_1D_OneByteInt = &
          -1 ! nf_put_vars_int1(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_put_var_1D_OneByteInt = &
          -1 ! nf_put_vara_int1(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_put_var_1D_TwoByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_TwoByteInt = &
          -1 ! nf_put_varm_int2(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_put_var_1D_TwoByteInt = &
          -1 ! nf_put_vars_int2(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_put_var_1D_TwoByteInt = &
          -1 ! nf_put_vara_int2(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_put_var_1D_FourByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_FourByteInt = &
          -1 ! nf_put_varm_int(ncid, varid, localStart, localCount, localStride, localMap, int(values))
     else if(present(stride)) then
       nf90_put_var_1D_FourByteInt = &
          -1 ! nf_put_vars_int(ncid, varid, localStart, localCount, localStride, int(values))
     else
       nf90_put_var_1D_FourByteInt = &
          -1 ! nf_put_vara_int(ncid, varid, localStart, localCount, int(values))
     end if
   ...
   function nf90_put_var_1D_FourByteReal(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_FourByteReal = &
          -1 ! nf_put_varm_real(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_put_var_1D_FourByteReal = &
          -1 ! nf_put_vars_real(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_put_var_1D_FourByteReal = &
          -1 ! nf_put_vara_real(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_put_var_1D_EightByteReal(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_put_var_1D_EightByteReal = &
          -1 ! nf_put_varm_double(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_put_var_1D_EightByteReal = &
          -1 ! nf_put_vars_double(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_put_var_1D_EightByteReal = &
          -1 ! nf_put_vara_double(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_get_var_1D_OneByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_OneByteInt = &
          -1 ! nf_get_varm_int1(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_get_var_1D_OneByteInt = &
          -1 ! nf_get_vars_int1(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_get_var_1D_OneByteInt = &
          -1 ! nf_get_vara_int1(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_get_var_1D_TwoByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_TwoByteInt = &
          -1 ! nf_get_varm_int2(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_get_var_1D_TwoByteInt = &
          -1 ! nf_get_vars_int2(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_get_var_1D_TwoByteInt = &
          -1 ! nf_get_vara_int2(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_get_var_1D_FourByteInt(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_FourByteInt = &
          -1 ! nf_get_varm_int(ncid, varid, localStart, localCount, localStride, localMap, defaultIntArray)
     else if(present(stride)) then
       nf90_get_var_1D_FourByteInt = &
          -1 ! nf_get_vars_int(ncid, varid, localStart, localCount, localStride, defaultIntArray)
     else
       nf90_get_var_1D_FourByteInt = &
          -1 ! nf_get_vara_int(ncid, varid, localStart, localCount, defaultIntArray)
     end if
   ...
   function nf90_get_var_1D_FourByteReal(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_FourByteReal = &
          -1 ! nf_get_varm_real(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_get_var_1D_FourByteReal = &
          -1 ! nf_get_vars_real(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_get_var_1D_FourByteReal = &
          -1 ! nf_get_vara_real(ncid, varid, localStart, localCount, values)
     end if
   ...
   function nf90_get_var_1D_EightByteReal(ncid, varid, values, start, count, stride, map)
     ...
     if(present(map))  then
       ...
       nf90_get_var_1D_EightByteReal = &
          -1 ! nf_get_varm_double(ncid, varid, localStart, localCount, localStride, localMap, values)
     else if(present(stride)) then
       nf90_get_var_1D_EightByteReal = &
          -1 ! nf_get_vars_double(ncid, varid, localStart, localCount, localStride, values)
     else
       nf90_get_var_1D_EightByteReal = &
          -1 ! nf_get_vara_double(ncid, varid, localStart, localCount, values)
     end if
