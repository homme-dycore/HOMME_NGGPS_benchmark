...
if ( $?HOMME_OUT ) then
	set out_dir = $HOMME_OUT/sweqx/swtc5-mr
	echo Found \$HOMME_OUT, output will be stored in $out_dir
else
	set out_dir = ~/scratch1/reg-test/sweqx/swtc5-mr
...
cp $start_dir/namelists/swtc5-mr.nl $out_dir/input.nl
cp $start_dir/../mesh_refine/grids/mountain_10_x8.g $out_dir/mountain_10_x8.g
cd $out_dir
