...
#   SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -Kieee -Mflushz")
    SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -Mflushz")
    # Needed by csm_share
  ...
  ELSEIF (CMAKE_Fortran_COMPILER_ID STREQUAL Intel)
    ...
    SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -fp-model precise -ftz -qno-opt-dynamic-align")
...
ELSE ()
  ...
  ELSE ()
    ...
    ELSEIF (CMAKE_Fortran_COMPILER_ID STREQUAL Intel)
#      SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -O3")
      SET(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} -O2 -xAVX") #phl
  ...
  ELSE ()
    ...
    ELSEIF (CMAKE_C_COMPILER_ID STREQUAL Intel)
      SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -O2 -qno-opt-dynamic-align")
